    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: 'calc(100vh - 64px)' }}>
      ...
      <div style={{ padding: '16px 28px', borderBottom: '1px solid var(--border)', background: 'var(--bg-surface)', flexShrink: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
          ...
          <button className="btn btn-secondary btn-sm" onClick={() => setMessages([{ role: 'ai', content: 'Chat cleared! How can I help you?', time: new Date().toLocaleTimeString() }])}>🗑 Clear Chat</button>
        </div>
