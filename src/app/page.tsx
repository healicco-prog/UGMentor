...
const features = [
  ...
  { icon: '🗂️', title: 'E-Portfolio', desc: 'Build a comprehensive digital portfolio showcasing your academic journey and achievements.' },
];
          ...
          <div className={styles.pricingGrid}>
            {plans.map((plan, i) => (
              <div key={i} className={`${styles.planCard} ${plan.highlight ? styles.planHighlight : ''}`}
                ...
                <Link href="/login" className={`btn ${plan.highlight ? 'btn-primary' : 'btn-secondary'} btn-lg`} style={{ width: '100%', justifyContent: 'center' }}>
                  {plan.cta}
                </Link>
              </div>
            ))}
